import{ac as It,ad as sm,ae as Ml,af as im,ag as om,ah as Zo,ai as Fl,aj as am,ak as os,al as um,am as cm,an as ie,ao as lm,ap as hm,aq as dm,ar as ei,as as Ol,at as Ll,au as fm,av as mm,aw as gm,ax as uc,ay as pm}from"./index-Bjp7c8L9.js";var cc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const be=new cm("@firebase/firestore");function xn(){return be.logLevel}function ay(r){be.setLogLevel(r)}function D(r,...t){if(be.logLevel<=ie.DEBUG){const e=t.map(ta);be.debug(`Firestore (${rr}): ${r}`,...e)}}function mt(r,...t){if(be.logLevel<=ie.ERROR){const e=t.map(ta);be.error(`Firestore (${rr}): ${r}`,...e)}}function Kt(r,...t){if(be.logLevel<=ie.WARN){const e=t.map(ta);be.warn(`Firestore (${rr}): ${r}`,...e)}}function ta(r){if(typeof r=="string")return r;try{/**
* @license
